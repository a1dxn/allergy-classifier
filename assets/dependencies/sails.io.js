...
(function() {
  ...
  function SailsIOClient(_providedSocketIO) {
    ...
    SailsSocket.prototype._connect = function() {
      ...
      // Log a warning if non-Node.js platform attempts to use `initialConnectionHeaders` for anything other than
      // `polling`.
      ...
      (function selfInvoking(cb) {
        ...
        self.on('disconnect', function() {
          ...
          // Loop through the callbacks for all in-progress requests, and call them each with an error indicating the
          // disconnect.
